...
public final class Client {
    ...
    public let buttonCommand: NCWrapper<Interaction>
    ...
    public init(intents: Intents = .unprivileged) {
        ...
        buttonCommand = .init(.buttonReaction, notificationCenter: notificationCenter)
    }
    ...
    private func handleEvent(_ data: GatewayIncoming.Data) {
        ...
        case .interaction(let interaction):
            ...
            case .messageComponent(let componentData):
                buttonCommand.emit(value: interaction)
            default: break
            }
